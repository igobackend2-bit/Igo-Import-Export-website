...
function AgricultureHubContent({ allProducts }: { allProducts: Product[] }) {
  ...
  const handleRequestQuote = (prod: Product) => {
    const msg = encodeURIComponent(
      `Hello IGO Team,\n\nI would like to request a quote for:\n*${prod.name}*\nCategory: ${prod.category}\nOrigin: ${prod.origin}\n\nPlease share pricing, MOQ, and packaging details.\n\nThank you.`
    );
    window.open(`https://wa.me/917397789803?text=${msg}`, '_blank');
  };
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="mt-auto pt-4 border-t border-brand-line flex items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="text-brand-green-950 text-xs font-bold hover:text-brand-amber transition flex items-center gap-1"
                      >
