  ...
  return (
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-brand-green-950">
      ...
      >
        ...
        <img 
          src="https://images.unsplash.com/photo-1595825833444-94302620e0e3?auto=format&fit=crop&w=2000&q=80" 
      ...
      <div className="container mx-auto px-4 relative z-20 pt-20">
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-white leading-tight mb-8 drop-shadow-2xl">
            Powering Global <br/>
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mb-12 leading-relaxed border-l-4 border-white/20 pl-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <Link href="#rfq" className="px-8 py-4 bg-brand-amber text-brand-ink font-bold rounded hover:bg-amber-400 transition shadow-[0_0_20px_rgba(196,154,58,0.3)] hover:shadow-[0_0_30px_rgba(196,154,58,0.6)] flex items-center justify-center gap-3 group">
              Post Your Requirement
              <i className="fa-solid fa-arrow-right transform group-hover:translate-x-2 transition-transform"></i>
            </Link>
            <Link href="/hub/agriculture" className="px-8 py-4 bg-white/10 text-white border border-white/20 font-bold rounded hover:bg-white/20 transition backdrop-blur-sm flex items-center justify-center gap-3">
